...
**IngramQuoteDate** | **DateOnly** | Date the Quote was initially Created. | [optional] 
...
**SpecialBidExpirationDate** | **DateOnly** | If a price discount has been applied to the quote - The date the discount expires and will no longer be applicable. | [optional] 
**Status** | **DateOnly** | This refers to the primary status of the quote.  API responses will return | [optional] 

...
namespace xi.sdk.resellers.Model
{
    ...
    public partial class VendorRequiredInforesponseInner : IValidatableObject
    {
        ...
        public VendorRequiredInforesponseInner(string quoteNumber = default, string ingramPartNumber = default, string vendorPartNumber = default, string planId = default, string planName = default, List<VendorRequiredInforesponseInnerResponseMessagesInner> responseMessages = default, List<VmfVriAdditionalAttributeContainer> vmfAdditionalAttributes = default, List<VmfVriAdditionalAttributeContainer> vriAdditionalAttributes = default)
        {
        ...
        */
        ...
        public List<VmfVriAdditionalAttributeContainer> VmfAdditionalAttributes { get; set; }

        /// <summary>
        /// Gets or Sets VriAdditionalAttributes
        /// </summary>
        [DataMember(Name = "vriAdditionalAttributes", EmitDefaultValue = false)]
        public List<VmfVriAdditionalAttributeContainer> VriAdditionalAttributes { get; set; }

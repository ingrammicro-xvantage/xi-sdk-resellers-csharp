...
namespace xi.sdk.resellers.Model
{
    ...
    public partial class OrderCreateResponseOrdersInner : IValidatableObject
    {
        ...
        public OrderCreateResponseOrdersInner(int numberOfLinesWithSuccess = default, int numberOfLinesWithError = default, int numberOfLinesWithWarning = default, string ingramOrderNumber = default, string ingramOrderDate = default, string notes = default, string orderType = default, decimal orderTotal = default, decimal freightCharges = default, decimal totalTax = default, string currencyCode = default, List<OrderCreateResponseOrdersInnerLinesInner> lines = default, List<OrderCreateResponseOrdersInnerMiscellaneousChargesInner> miscellaneousCharges = default, List<OrderCreateResponseOrdersInnerLinksInner> links = default, List<OrderCreateResponseOrdersInnerRejectedLineItemsInner> rejectedLineItems = default, List<OrderCreateResponseOrdersInnerAdditionalAttributesInner> additionalAttributes = default)
        {

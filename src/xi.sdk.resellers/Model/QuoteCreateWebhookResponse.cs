...
namespace xi.sdk.resellers.Model
{
    ...
    /// </summary>
    [DataContract(Name = "quote_create_webhook_response")]
    public partial class QuoteCreateWebhookResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QuoteCreateWebhookResponse" /> class.
        /// </summary>
        ...
        public QuoteCreateWebhookResponse(string topic = default(string), string varEvent = default(string), string eventTimeStamp = default(string), string eventId = default(string), QuoteCreateWebhookResponseResource resource = default(QuoteCreateWebhookResponseResource))
        {
            this.Topic = topic;
            this.Event = varEvent;
        ...
        public QuoteCreateWebhookResponseResource Resource { get; set; }

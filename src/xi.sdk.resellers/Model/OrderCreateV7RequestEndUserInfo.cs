...
namespace xi.sdk.resellers.Model
{
    ...
    public partial class OrderCreateV7RequestEndUserInfo : IValidatableObject
    {
        ...
        public OrderCreateV7RequestEndUserInfo(string endUserId = default, string contact = default, string companyName = default, string addressLine1 = default, string addressLine2 = default, string city = default, string state = default, string postalCode = default, string countryCode = default, string phoneNumber = default, string email = default)
        {

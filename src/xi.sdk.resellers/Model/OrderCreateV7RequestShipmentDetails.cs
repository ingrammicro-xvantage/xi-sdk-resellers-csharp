...
namespace xi.sdk.resellers.Model
{
    ...
    public partial class OrderCreateV7RequestShipmentDetails : IValidatableObject
    {
        ...
        public OrderCreateV7RequestShipmentDetails(string carrierCode = default, string requestedDeliveryDate = default, string shipComplete = default, string shippingInstructions = default, string freightAccountNumber = default, bool? signatureRequired = default)
        {
